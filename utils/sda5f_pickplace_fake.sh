...
sleep 3.
byobu send-keys -t 2 'xhost + && docker exec -it sda5f_container bash -it -c "roslaunch sda5f_motion_plan demo_pickplace.launch fake_execution:=true planning_space:=joint"' 'C-m'
